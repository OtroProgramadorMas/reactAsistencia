...
import { Container, Typography, Box, Button, Dialog, DialogTitle, DialogContent, TextField } from "@mui/material";
  ...
  return (
    <Container maxWidth="md" sx={{ textAlign: 'center', my: 4 }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'center' }}>
        <Button variant="contained" onClick={() => handleOpen("Administrativo")} >Registrar Administrativo</Button>
        <Button variant="contained" onClick={() => handleOpen("Instructor")} >Registrar Instructor</Button>
        <Button variant="contained" onClick={() => handleOpen("Aprendiz")} >Registrar Aprendiz</Button>
      </Box>
